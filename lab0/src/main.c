...
int main()
{
	long int a, b,indx=0,tochka=0,tochka1=0,numeral,part1=0,part2=0,step=1,part1_size=0,p1=0;
	char X[13];
	if (scanf("%ld", &a) != 1) 
	{
	    exit(0);
	...
	for (long int i=0; i<part1_size; (part1/=b),i++)
	{
		symbol = part1 % b;
		if (symbol <= 9)
		{
	...
	if(tochka1!=0&&tochka==2&&copy_part2!=0)
	{
	    printf("%s",".");
	}
	if(y>12)
